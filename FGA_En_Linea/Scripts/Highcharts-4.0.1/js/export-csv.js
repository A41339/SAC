...
(function (factory) {
    ...
    Highcharts.Chart.prototype.viewData = function () {
        ...
        $('#' + id).DataTable({
            dom: 'Bfrtip', buttons: [{ extend: 'copy', filename: 'fga' }, { extend: 'csv', filename: 'fga' }, { extend: 'excel', filename: 'fga' },
            { extend: 'pdf', filename: 'fga', title:'FGA' }, { extend: 'print', filename: 'fga' }], sort: false
        });
    };
