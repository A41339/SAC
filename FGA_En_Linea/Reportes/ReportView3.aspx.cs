...
{
    public partial class ReportView3 : System.Web.Mvc.ViewPage
    {
        ...
        private void RenderReportModels()
        {
            try
            {
                if (Session["TipoReporte3"] != null)
                {
                    ReportViewerRSFReports3.Height = 1300;
                    var rptName = string.Empty;

                    switch (Session["TipoReporte3"].ToString())
                    {
                        case "rpt_balance":
                    ...
                    ReportViewerRSFReports3.ProcessingMode = ProcessingMode.Remote;
                    ReportViewerRSFReports3.ZoomMode = ZoomMode.Percent;
                    ReportViewerRSFReports3.ZoomPercent = 90;
                    ...
                    serverReport = ReportViewerRSFReports3.ServerReport;
                    ...
                    ReportViewerRSFReports3.ShowParameterPrompts = false;
                    ReportViewerRSFReports3.AsyncRendering = true;
