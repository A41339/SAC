<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportView4.aspx.cs" Inherits="FGA.Reportes.ReportView4" %>
            ...
            <div class="col-lg-12">
                <form id="form2" runat="server">
                    ...
                    <%if (Session["TipoReporte4"] != null)
                        {  %>
                    <rsweb2:ReportViewer ID="ReportViewerRSFReports4" runat="server" EnableEventValidation="false" AsyncRendering="true"
