...
{
    public partial class ReportView2 : System.Web.Mvc.ViewPage
    {
        ...
        private void RenderReportModels()
        {
            try
            {
                ...
                {
                    ReportViewerRSFReports2.Height = 1300;
                    var rptName = string.Empty;

                    switch (Session["TipoReporte2"].ToString())
                    {
                        case "rpt_balance":
                        ...
                        case "rpt_er_proy":
                            ...
                            break;
                        case "rpt_factura_ffc":
                            rptName = "Report_Fact_FFC";
                            break;
                        default:
                            break;
                    }
                    ...
                    ReportViewerRSFReports2.ProcessingMode = ProcessingMode.Remote;
                    ReportViewerRSFReports2.ZoomMode = ZoomMode.Percent;
                    ReportViewerRSFReports2.ZoomPercent = 90;
                    ...
                    serverReport = ReportViewerRSFReports2.ServerReport;
                    ...
                    ReportViewerRSFReports2.ShowParameterPrompts = false;
                    ReportViewerRSFReports2.AsyncRendering = true;

                    var parameters = new List<ReportParameter>();
                    if (rptName == "Report_Fact_FFC")
                    {
