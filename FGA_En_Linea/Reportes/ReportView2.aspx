<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportView2.aspx.cs" Inherits="FGA.Reportes.ReportView2" %>
            ...
            <div class="col-lg-12">
                <form id="form2" runat="server">
                    ...
                    <%if (Session["TipoReporte2"] != null)
                        {  %>
                    <rsweb2:ReportViewer ID="ReportViewerRSFReports2" runat="server" EnableEventValidation="false" AsyncRendering="true"
